## Hello! My name is Aidan Ward, and welcome to my GitHub resume! 👋
...
- Contributing to the software on PURC’s PacBot project team since Fall 2022, including writing the path-finding algorithms for our robot in the maze and maintaining the game engine, and developing the movement dynamics and communications software for PURC’s BB-8 Star Wars Droid replica. Software and other documentation for PURC's various projects can be found in the linked organization.
...
#### 🔍 [Natural Language Processing Project at Princeton University – Spring 2025:](https://github.com/AnuptaA/Ablating-Semantic-Underspecification)
- Completed a research project for the Natural Language Processing course (COS 484) alongside Anupta Argo and Eshaan Govil on vision-language models focused on their ability to detect semantic underspecification.
- Wrote the paper and presented the poster: *Ablating Semantic Underspecification: A Comparative Study of CLIP-Based Vision-Language Models*, with the paper, poster, and corresponding code for the research being available in the linked repository.
